...
function loadNameForge() {
  $('#workSpace').append('<div id="close" class="fade-in fade-in-two">X</div>');
  $('#workSpace').append('<div id="forgeSpace" class="fade-in fade-in-one"><div id="forgeTitle">The Name Forge</div><p>Halfling loaders not built. Library will be updated and expanded soon!</p><select id="nameRace" class="options"><option selected disabled>Race</option><option value="human">Human</option><option value="elf">Elf</option><option value="dwarf">Dwarf</option><option value="halfling">Halfling</option><option value="orc">Orc</option></select><select id="nameGender" class="options"><option selected disabled>Gender</option><option value="male">Male</option><option value="female">Female</option></select></br><button id="forgeButton" class="btn btn-primary">Forge!</button><div id="resultField"><h2 id="result"></h2></div></div>');
  //Close Forge
  $('#close').click(function () {
    $('#workSpace').empty();
    loadWeaponButton();
  ...
  humanPre = {
    'male': ['Thom', 'Ja', 'Te', 'Arn', 'Ed', 'Bre', 'Bra', 'Ben', 'Ry', 'Chr', 'Der', 'Mich', 'Dam', 'Eric', 'Jan', 'Bar', 'Cha', 'Mit', 'Wil', 'Eld', 'Nic', 'Aar', 'Ad', 'Rhyn', 'Jae', 'Dor', 'Alla', 'Al', 'Era', 'Ave', 'Pal', 'Paul', 'Ald', 'Jos', 'Abel', 'Tor', 'Jac', 'Mal', 'Nor', 'Geor', 'Quinn', 'Hen', 'Har', 'Hal', 'Sam', 'Kar', 'Ked', 'Cad',],
  ...
  humanPost = {
    'male': ['mon', 'son', 'sen', 'end', 'aer', 'on', 'ek', 'ed', 'mir', 'ir', 'id', 'ron', 'don', 'den', 'car', 'nir', 'vir', 'sir', 'thar', 'then', 'ek', 'mond', 'mend', 'don', 'den', 'len', 'car', 'card', 'ward', 'thar', 'dar', 'eth', 'bar', 'ry', 'nar', 'ir', 'is'],
